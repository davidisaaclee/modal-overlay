...
gulp.task('coffee', function () {
  var bundle = browserify(_.extend(options.coffee.options, {
    entries: './modal-overlay.coffee',
    outputName: 'modal-overlay.js',
    transform: [coffeeify]
  })).bundle();
...
gulp.task('demo_script', function () {
  var bundle = browserify(_.extend(options.coffee.options, {
    entries: './demo/modal-overlay-demo.coffee',
    outputName: 'modal-overlay-demo.js',
    transform: [coffeeify]
  })).bundle();
  ...
  return bundle
    .pipe(source('modal-overlay-demo.js'))
    .pipe(buffer())
